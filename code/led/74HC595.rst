      ...
      000000                        458 	.ds 8
                                    ...
                                    531 ;	-----------------------------------------
      000140                        532 __74HC595_WriteByte:
                           000007   533 	ar7 = 0x07
                           000006   534 	ar6 = 0x06
                           000005   535 	ar5 = 0x05
                           000004   536 	ar4 = 0x04
                           ...
                           000001   539 	ar1 = 0x01
                           000000   540 	ar0 = 0x00
      000140 AF 82            [24]  541 	mov	r7, dpl
                                    542 ;	code/led/74HC595.c:18: for (i = 0; i < 8; i++)
      000142 7E 00            [12]  543 	mov	r6,#0x00
      000144                        544 00102$:
                                    545 ;	code/led/74HC595.c:20: SER = Byte & (0x80 >> i);
      000144 8E F0            [24]  546 	mov	b,r6
      000146 05 F0            [12]  547 	inc	b
      000148 7C 80            [12]  548 	mov	r4,#0x80
      00014A E4               [12]  549 	clr	a
      00014B FD               [12]  550 	mov	r5,a
      00014C 33               [12]  551 	rlc	a
      00014D 92 D2            [24]  552 	mov	ov,c
      00014F 80 08            [24]  553 	sjmp	00120$
      000151                        554 00119$:
      000151 A2 D2            [12]  555 	mov	c,ov
      000153 ED               [12]  556 	mov	a,r5
      000154 13               [12]  557 	rrc	a
      000155 FD               [12]  558 	mov	r5,a
      000156 EC               [12]  559 	mov	a,r4
      000157 13               [12]  560 	rrc	a
      000158 FC               [12]  561 	mov	r4,a
      000159                        562 00120$:
      000159 D5 F0 F5         [24]  563 	djnz	b,00119$
      00015C 8F 02            [24]  564 	mov	ar2,r7
      00015E 7B 00            [12]  565 	mov	r3,#0x00
      000160 EA               [12]  566 	mov	a,r2
      000161 52 04            [12]  567 	anl	ar4,a
      000163 EB               [12]  568 	mov	a,r3
      000164 52 05            [12]  569 	anl	ar5,a
                                    570 ;	assignBit
      000166 EC               [12]  571 	mov	a,r4
      000167 4D               [12]  572 	orl	a,r5
      000168 24 FF            [12]  573 	add	a,#0xff
      00016A 92 B2            [24]  574 	mov	_SER,c
                                    575 ;	code/led/74HC595.c:21: SCK = 1;
                                    576 ;	assignBit
      00016C D2 B4            [12]  577 	setb	_SCK
                                    578 ;	code/led/74HC595.c:22: SCK = 0;
                                    579 ;	assignBit
      00016E C2 B4            [12]  580 	clr	_SCK
                                    581 ;	code/led/74HC595.c:18: for (i = 0; i < 8; i++)
      000170 0E               [12]  582 	inc	r6
      000171 BE 08 00         [24]  583 	cjne	r6,#0x08,00121$
      000174                        584 00121$:
      000174 40 CE            [24]  585 	jc	00102$
                                    586 ;	code/led/74HC595.c:24: RCK = 1;
                                    587 ;	assignBit
      000176 D2 B3            [12]  588 	setb	_RCK
                                    589 ;	code/led/74HC595.c:25: RCK = 0;
                                    590 ;	assignBit
      000178 C2 B3            [12]  591 	clr	_RCK
                                    592 ;	code/led/74HC595.c:26: }
      00017A 22               [24]  593 	ret
                                    594 	.area CSEG    (CODE)
                                    595 	.area CONST   (CODE)
                                    596 	.area XINIT   (CODE)
