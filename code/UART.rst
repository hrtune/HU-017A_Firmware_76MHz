      ...
      001286 75 98 50         [24]  535 	mov	_SCON,#0x50
                                    536 ;	code/UART.c:7: AUXR |= 0x01; // 串口1选择定时器2为波特率发生器
      001289 43 8E 01         [24]  537 	orl	_AUXR,#0x01
                                    538 ;	code/UART.c:8: AUXR |= 0x04; // 定时器2时钟为Fosc,即1T
      00128C 43 8E 04         [24]  539 	orl	_AUXR,#0x04
                                    540 ;	code/UART.c:9: T2L = 0x41;	  // 设定定时初值
      00128F 75 D7 41         [24]  541 	mov	_T2L,#0x41
                                    542 ;	code/UART.c:10: T2H = 0xFD;	  // 设定定时初值
      001292 75 D6 FD         [24]  543 	mov	_T2H,#0xfd
                                    544 ;	code/UART.c:11: AUXR |= 0x10; // 启动定时器2
      001295 43 8E 10         [24]  545 	orl	_AUXR,#0x10
                                    546 ;	code/UART.c:12: }
      001298 22               [24]  547 	ret
                                    548 ;------------------------------------------------------------
                                    ...
                                    556 ;	-----------------------------------------
      001299                        557 _Uart_SendChar:
      001299 85 82 99         [24]  558 	mov	_SBUF,dpl
                                    559 ;	code/UART.c:17: while (!TI)
      00129C                        560 00101$:
                                    561 ;	code/UART.c:19: TI = 0;
                                    562 ;	assignBit
      00129C 10 99 02         [24]  563 	jbc	_TI,00118$
      00129F 80 FB            [24]  564 	sjmp	00101$
      0012A1                        565 00118$:
                                    566 ;	code/UART.c:20: }
      0012A1 22               [24]  567 	ret
                                    568 ;------------------------------------------------------------
      ...
      0012A2 AE 82            [24]  579 	mov	r6,dpl
      0012A4 AF 83            [24]  580 	mov	r7,dph
      0012A6 C0 07            [24]  581 	push	ar7
      0012A8 C0 06            [24]  582 	push	ar6
      0012AA 12 12 99         [24]  583 	lcall	_Uart_SendChar
      0012AD D0 06            [24]  584 	pop	ar6
      0012AF D0 07            [24]  585 	pop	ar7
                                    586 ;	code/UART.c:25: return c;
      0012B1 8E 82            [24]  587 	mov	dpl, r6
      0012B3 8F 83            [24]  588 	mov	dph, r7
                                    589 ;	code/UART.c:26: }
      0012B5 22               [24]  590 	ret
                                    591 	.area CSEG    (CODE)
                                    592 	.area CONST   (CODE)
                                    593 	.area XINIT   (CODE)
